          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
            ...
            <div className="space-y-6">
              <div className="flex items-center">
                ...
                <img
                  src="/logo.png" // ✅ `public/logo.png` — to'g'ri yo'l
                ...
                {[
                  ...
                  <li key={index}>
                   <button
                     ...
                     className="text-gray-400 hover:text-[#00A651] transition-colors flex items-center space-x-2 group w-full text-left"
>
                   <ArrowRight className="w-4 h-4 opacity-0 group-hover:opacity-100 -ml-6 group-hover:ml-0 transition-all" />
                     <span>{service}</span>
                        </button>
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div className="text-gray-400">Buxoro shahar, O'zbekiston</div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-10 h-10 bg-[#00A651]/20 rounded-lg flex items-center justify-center flex-shrink-0">
                    <Phone className="w-5 h-5 text-[#00A651]" />
                  </div>
                  <div className="text-gray-400">+998 90 123 45 67</div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-10 h-10 bg-[#00A651]/20 rounded-lg flex items-center justify-center flex-shrink-0">
